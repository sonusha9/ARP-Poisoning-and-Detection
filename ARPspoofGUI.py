...
class ARPSpoofGUI:
    def __init__(self, master):
        self.master = master
        master.title("ARP poisoning Tool - Attacker Terminal")
        ...
        # Title Label
        self.title_label = tk.Label(master, text="ARP poisoning Tool", font=("Segoe UI", 20, "bold"), fg="#ff4d4d", bg="#1e1e1e")
        ...
        self.start_button = tk.Button(self.button_frame, text="Start poisoning", font=("Segoe UI", 12, "bold"), fg="white", bg="#4CAF50", command=self.start_spoofing)
    ...
    def start_spoofing(self):
        ...
        self.status_label.config(text="Status: poisoning in progress...", fg="#ffcc00")
        self.packets_sent = 0
    ...
    def stop_spoofing(self):
        ...
        try:
            ...
            self.status_label.config(text="Status: ARP tables restored. poisoning stopped.", fg="#66ff66")
        except Exception as e:
